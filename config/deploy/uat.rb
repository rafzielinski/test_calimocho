set :stage, :uat
set :branch, :uat
set :deploy_to, '/var/www/uat/test_calimocho'
set :rvm1_ruby_version, '2.5.5'

# set :default_env, { rvm_path: '/usr/local/rvm' }
# set :rvm1_map_bins, %w(rake gem bundle ruby honeybadger)

role :app, %w{test_calimocho-uat.canneroni.com}
role :web, %w{test_calimocho-uat.canneroni.com}
role :db,  %w{test_calimocho-uat.canneroni.com}
...
server 'test_calimocho-uat.canneroni.com', user: 'deployer', roles: %w{web app}
